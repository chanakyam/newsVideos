...
welcome(Req, State) ->
	...
	Popular_Videos_Url = "http://api.contentapi.ws/videos?channel=world_news&limit=6&skip=4&format=short",
	...
	More_Videos_Url = "http://api.contentapi.ws/videos?channel=world_news&limit=12&skip=8&format=short",
